  ...
  export default function Login() {
    const userInfo = {
      ...
      "country_code": "+91",  //Replace Your Country Code
      "phone_no": "**********"  // Replace your phone number
    }
    const URL = `https://phone.email/auth/sign-in?countrycode=${userInfo.country_code}&phone_no=${userInfo.phone_no}&redirect_url=${userInfo.redirect_url}`;
